...
//////////////////////////////////////////////////////////////////////////
// APunchKick03Character

APunchKick03Character::APunchKick03Character()
{
...
void APunchKick03Character::BeginPlay()
{
	Super::BeginPlay();
...
void APunchKick03Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &APunchKick03Character::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &APunchKick03Character::MoveRight);

	// We have 2 versions of the rotation bindings to handle different kinds of devices differently
	// "turn" handles devices that provide an absolute delta, such as a mouse.
	// "turnrate" is for devices that we choose to treat as a rate of change, such as an analog joystick
	PlayerInputComponent->BindAxis("Turn", this, &APawn::AddControllerYawInput);
	PlayerInputComponent->BindAxis("TurnRate", this, &APunchKick03Character::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &APunchKick03Character::LookUpAtRate);

	// handle touch devices
	PlayerInputComponent->BindTouch(IE_Pressed, this, &APunchKick03Character::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &APunchKick03Character::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &APunchKick03Character::OnResetVR);

	// attack functionality
	PlayerInputComponent->BindAction("Attack", IE_Pressed, this, &APunchKick03Character::AttackInput);
	PlayerInputComponent->BindAction("Attack", IE_Released, this, &APunchKick03Character::AttackEnd);
}

void APunchKick03Character::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void APunchKick03Character::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void APunchKick03Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}

void APunchKick03Character::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void APunchKick03Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void APunchKick03Character::MoveForward(float Value)
{
...
void APunchKick03Character::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
...
void APunchKick03Character::AttackInput()
{
...
void APunchKick03Character::AttackStart()
{
	Log(ELogLevel::INFO, __FUNCTION__);
...
void APunchKick03Character::Log(ELogLevel LogLevel, FString Message, ELogOutput LogOutput)
{
